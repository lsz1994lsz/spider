...
# Scrapy settings for walian_kuaixun project
#
...
BOT_NAME = 'walian_kuaixun'

SPIDER_MODULES = ['walian_kuaixun.spiders']
NEWSPIDER_MODULE = 'walian_kuaixun.spiders'

# ===============================
TELNETCONSOLE_PORT = 12351
WEBSERVICE_PORT = 54351
# ==============日志相关=================
...
# ================piplines=======================
ITEM_PIPELINES = {
    'walian_kuaixun.pipelines.WalianKuaixunPipeline': 600,
}
# ==================模拟真实===========================
