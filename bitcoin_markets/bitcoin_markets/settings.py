...
# Scrapy settings for bitcoin_markets project
#
...
BOT_NAME = 'bitcoin_markets'

SPIDER_MODULES = ['bitcoin_markets.spiders']
NEWSPIDER_MODULE = 'bitcoin_markets.spiders'


# ===============================
TELNETCONSOLE_PORT = 12353
WEBSERVICE_PORT = 54353
# ==============日志相关=================
...
# ================piplines=======================
ITEM_PIPELINES = {
    'bitcoin_markets.pipelines.BitcoinMarketsPipeline': 600,
}
# ==================模拟真实===========================
