# -*- coding: utf-8 -*-
# Scrapy settings for short_positions project
#
# For simplicity, this file contains only the most important settings by
# default. All the other settings are documented here:
#
#     http://doc.scrapy.org/en/latest/topics/settings.html
TELNETCONSOLE_PORT = 12343
...
# 记录Scrapy中的标准输出
# LOG_STDOUT = False
BOT_NAME = 'short_positions'
SPIDER_MODULES = ['short_positions.spiders']
NEWSPIDER_MODULE = 'short_positions.spiders'
# ================piplines=======================
ITEM_PIPELINES = {
