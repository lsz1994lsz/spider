...
# Scrapy settings for boc_exchange_rate project
#
...
BOT_NAME = 'boc_exchange_rate'

SPIDER_MODULES = ['boc_exchange_rate.spiders']
NEWSPIDER_MODULE = 'boc_exchange_rate.spiders'


# ===============================
TELNETCONSOLE_PORT = 12348
WEBSERVICE_PORT = 54328
# ==============日志相关=================
...
# ================piplines=======================
ITEM_PIPELINES = {
    'boc_exchange_rate.pipelines.BocExchangeRatePipeline': 600,
}
# ==================模拟真实===========================
...
# Crawl responsibly by identifying yourself (and your website) on the user-agent
#USER_AGENT = 'boc_exchange_rate (+http://www.yourdomain.com)'
