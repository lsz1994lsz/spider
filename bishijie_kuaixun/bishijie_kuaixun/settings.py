...
# Scrapy settings for bishijie_kuaixun project
#
...
BOT_NAME = 'bishijie_kuaixun'

SPIDER_MODULES = ['bishijie_kuaixun.spiders']
NEWSPIDER_MODULE = 'bishijie_kuaixun.spiders'

# ===============================
TELNETCONSOLE_PORT = 12352
WEBSERVICE_PORT = 54352
# ==============日志相关=================
...
# ================piplines=======================
ITEM_PIPELINES = {
    'bishijie_kuaixun.pipelines.BishijieKuaixunPipeline': 600,
}
# ==================模拟真实===========================
