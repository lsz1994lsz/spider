...
# Scrapy settings for walian project
#
...
SPIDER_MODULES = ['walian.spiders']
NEWSPIDER_MODULE = 'walian.spiders'



# ===============================
TELNETCONSOLE_PORT = 12350
WEBSERVICE_PORT = 54350
# ==============日志相关=================
...
# ================piplines=======================
ITEM_PIPELINES = {
    'walian.pipelines.WalianPipeline': 600,
}
# ==================模拟真实===========================
