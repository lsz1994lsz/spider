...
class WalianPipeline(object):
    ...
    def __save_mysql(self, li):
        ...
        cur = self.db.cursor()
        sql = "select count(id) from walian where title = %s;"
        ...
        if result[0] != 0:
            ...
            with self.db.atomic():
                ...
                walian.insert(title = li['title'] ,text = li['text'], record_timestamp = record_timestamp).execute()
